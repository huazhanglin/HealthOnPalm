...
const META =
  "版本 1.0.1 · 生效日期 2026年9月12日 · 提供者 Steven Lin";
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "硅基流动（SiliconFlow，https://www.siliconflow.com）：第三方大模型与语音处理服务。仅在您于 App 内点「同意」之后，我们才会通过自有云函数向其发送：助手对话文字；若使用语音则先转写再发送；生成晨间简报或训练计划时，发送您已授权的当日健康摘要（如活动、睡眠、心率类指标）以及档案中的运动偏好。我们不发送临床病历、处方、实验室结果或密码。",
        "若您选择「暂不使用 AI」，仍可手动记录运动、睡眠、心情并查看已有数据；助手、AI 晨报、AI 训练计划和语音将关闭。您可随时在「我的 → 账号与隐私 → 第三方 AI 处理」更改。仅将本说明写在隐私政策中不足以构成同意，因此我们会在 App 内单独询问。",
